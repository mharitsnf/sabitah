...
const MENU_FILTER_GALLERY: String = "MENU_FILTER_GALLERY"
const MENU_GEOTAG_TO_ISLAND: String = "MENU_GEOTAG_TO_ISLAND"
...
const MENU_MEMORY_CATEGORIES_MENU: String = "MENU_MEMORY_CATEGORIES_MENU"
